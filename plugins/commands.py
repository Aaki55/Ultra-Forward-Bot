...
main_buttons = [[
        ...
        InlineKeyboardButton('📜 sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ', url='https://t.me/rxbotz'),
        InlineKeyboardButton('📢 ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ', url='https://t.me/rxbotz')
        ],[
...
async def restart(client, message):
    msg = await message.reply_text(
        text = "<i>If you like our bot ❤️😊 Keep supporting us and share our Bot 🙃</i>"
        )
