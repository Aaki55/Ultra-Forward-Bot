...
class Config:
    ...
    DATABASE_URI = environ.get("DATABASE", "mongodb+srv://isha1470:rvi2uo5wacfGVSqB@cluster0.fvezv.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
    DATABASE_NAME = environ.get("DATABASE_NAME", "RxForward_v1")
